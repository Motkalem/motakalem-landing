...
class CenterPackagesController extends AdminBaseController
{
    public function index()
    {
        $search = request()->query('search');

        $query = CenterPackage::query();
        ...
        $packagesCount = CenterPackage::query()->count();

        return view('admin.center-packages.index',   compact('packages','title', 'packagesCount'));
    }
    ...
    {
        $title= 'إنشاء باقة';
        return view('admin.center-packages.create', compact('title'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('dashboard.center.center-packages.index')->with('success', 'CenterPackage created successfully.');
    }
    ...
    public function edit($id)
    {
        ...
        $package = CenterPackage::findOrFail($id);

        return view('admin.center-packages.edit', compact('package','title'));
    }
    ...
    public function update(Request $request, $id) : RedirectResponse
    {
        ...
        return redirect()->route('dashboard.center.center-packages.index')->with('success', 'CenterPackage updated successfully.');
    }
...
//    {
//
//        $package = CenterPackage::with('payments')->findOrFail($id);
//
//        Helper::tryDelete($package);
//
//         return redirect()->route('dashboard.center.center-packages.index');
//    }
}
