...
<head>
    ...
    <title>رابط سداد القسط لبرنامج متكلم</title>
</head>
...
<div style="width: 75%; margin: auto; border: 1px solid #06A996; border-radius: 10px; overflow: hidden;">
    ...
    <div style="background-color: #F7F7F7; padding: 2rem;">
        ...
        <p style="text-align: center; color: #666; margin-bottom: 1rem;">
            نرجو منكم إتمام سداد القسط المستحق ضمن خطة برنامج متكلم لتحسين النطق.
        </p>
        <p style="text-align: center; color: #666; margin-bottom: 2rem;">
            يمكنكم استخدام الرابط أدناه لإتمام سداد القسط بكل سهولة وأمان.
        </p>

        <div style="text-align: center; margin-top: 1.5rem;">
            <a href="{{ $installment_url }}" target="_blank" style="display: inline-block; background-color: #06A996; color: #fff; padding: 0.8rem 2rem; border-radius: 5px; text-decoration: none; font-size: 1rem;">
                سداد القسط الآن
            </a>
        </div>
    </div>
