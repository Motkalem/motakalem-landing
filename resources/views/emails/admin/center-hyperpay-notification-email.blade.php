    ...
    <div style="width: 75%; margin: auto; border: .2px solid #06A996">
        ...
        <div style="background-color: #D9D9D9;padding: 2rem;">
            <div style="text-align: center;">
                 <div>
                    <p style="font-size: 1.2rem; font-weight: 600;"> مركز متكلم: إشعار بعملية دفع قسط مركز متكلم </p>
                </div>
            </div>
            <hr />
            <table>
                ...
                <tr>
                    ...
                    <td>{{ data_get($notification, 'centerInstallmentPayment.patient.name')}}</td>
                </tr>

                <tr>
                    <td style="display: inline-block; margin-left:.6rem; font-weight: 600;">البريد الإلكتروني للطالب: </td>
                    <td>{{ data_get($notification, 'centerInstallmentPayment.patient.email') }}</td>
                </tr>
                <tr>
                    <td style="display: inline-block; margin-left:.6rem; font-weight: 600;"> رقم الهاتف  : </td>
                    <td>{{ data_get($notification, 'centerInstallmentPayment.patient.mobile_number') }}</td>
                </tr>
                <tr>
