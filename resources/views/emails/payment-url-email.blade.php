...
<head>
    ...
    <title>رابط الدفع لإشتراكم في برنامج متكلم</title>
</head>
...
<div style="width: 75%; margin: auto; border: 1px solid #06A996; border-radius: 10px; overflow: hidden;">
    ...
    <div style="background-color: #F7F7F7; padding: 2rem;">
        ...
        <p style="text-align: center; color: #666; margin-bottom: 2rem;">
              إذا واجهتك مشكلة في إتمام عملية الدفع، برجاء استخدام الرابط أدناه.
        </p>

        <div style="text-align: center; margin-top: 1.5rem;">
            <a href="{{ $payment_url }}" target="_blank" style="display: inline-block; background-color: #06A996; color: #fff; padding: 0.8rem 2rem; border-radius: 5px; text-decoration: none; font-size: 1rem;">الدفع الآن</a>
        </div>
    </div>
