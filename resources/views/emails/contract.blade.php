                                        ...
                                        <td align="right"
                                            ...
                                            <ul style="font-family:Cairo,Geneva,sans-serif">
                                                ...
                                                <li style="font-size:16px;font-family:Cairo,Geneva,sans-serif;color:rgb(38,38,38);padding-bottom:10px">
                                                    ...
                                                    <br/>
                                                    4. تاريخ بدء
                                                    الدورة: {{ Carbon::parse($data->package?->starts_date)?->format('Y/n/j')  }}
                                                    .
                                                    <br/>
                                                    5. تاريخ انتهاء
                                                    الدورة: {{ Carbon::parse($data->package?->ends_date)?->format('Y/n/j')  }}
                                                    .
                                                </li>
                                                <li style="font-size:16px;font-family:Cairo,Geneva,sans-serif;color:rgb(38,38,38);padding-bottom:10px">
                                                    ...
                                                    @if($data->package?->payment_type !== \App\Models\Package::ONE_TIME)
                                                        ...
                                                        @for ($i = 0; $i < $data->package?->number_of_months; $i++)
                                                            ...
                                                            @elseif ($i == 2)
                                                                يدفع قبل بدأ المرحلة الثالثة
                                                            @elseif ($i == 3)
                                                                يدفع قبل بدأ المرحلة الرابعة
                                                            @elseif ($i == 4)
                                                                يدفع قبل بدأ المرحلة الخامسة
                                                            @elseif ($i == 5)
                                                                يدفع قبل بدأ المرحلة السادسة
                                                            @elseif ($i == 7)
                                                                يدفع قبل بدأ المرحلة السابعة
                                                            @endif
                                                            <br/>
                                                        @endfor
                                                    @endif
