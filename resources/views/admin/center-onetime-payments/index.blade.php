                                        ...
                                        <div class="payment-actions">
                                            @if(!$centerPayment->is_finished)
                                                <button type="button"
                                                        ...
                                                        class="px-2 btn btn-warning bgc-yellow-800 btn-sm text-white send-pay-link-btn">
                                                    إرسال رابط الدفع
                                                </button>
                                            @endif
        ...
        <div class="modal-dialog modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="px-2 btn btn-warning bgc-yellow-800 text-white btn-sm send-contract-btn" id="confirmSendPayLink">
                        نعم، أرسل الرابط
                    </button>
                </div>
            </div>
    ...
    @push('scripts')
        ...
        <script>
            ...
            document.addEventListener('DOMContentLoaded', function () {
                let paymentId;
                let confirmButton = document.getElementById('confirmSendPayLink');
                ...
                confirmButton.onclick = function (e) {
                    ...
                    this.disabled = true;
                    this.innerHTML = '<i class="fas fa-spinner fa-spin me-1"></i> جاري الإرسال...';
                    ...
                    fetch(url, {
                        ...
                        .finally(() => {
                            ...
                            confirmButton.innerHTML = 'نعم، أرسل الرابط';
