...
<div class="routing">
    ...
    <div style="height: 650px;padding-top:50px;  margin-bottom:0px; direction: ltr ">
        ...
        <h1 class="text-center" style="text-align: center">ستقوم بدفع مبلغ {{$amount . __('SAR')}}</h1>
        ...
        @else
            ...
            <div class="payment-options" style="text-align: center; margin-top: 20px;">
                <a href="{{ url()->current() }}?{{ http_build_query(array_merge($_GET, ['brand' => 'visa'])) }}"
                   style="display: inline-block; text-decoration: none;">
                    <img src="{{asset('images/brands/visa.png')}}" style="padding-right: 5px; width: 150px;" alt="Visa" />
                </a>
                &emsp13;
                ...
                <a href="{{ url()->current() }}?{{ http_build_query(array_merge($_GET, ['brand' => 'mada'])) }}"
                   style="display: inline-block; text-decoration: none;">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 151.61 50.54" width="150px" height="auto">
