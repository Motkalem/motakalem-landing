...
CloudflareApps.siteId = "2283fb53dde6bd33e0d2889e9cd07a18";
    ...
    CloudflareApps.createElement = function createElement(options, prevEl) {
        ...
        try {
            ...
            switch (options.method) {
                ...
                case "replace":
                    try {
                        var id = (element.cfAppsElementId =
...
CloudflareApps.installs["6bcjYSbmEr7o"] = { appId: "nGAnsTeiPCQx", scope: {} };
CloudflareApps.installs["6bcjYSbmEr7o"].options = {
    subdomain_tracker_ids: [{ subdomain: "", tracker_id: "" }],
    tracker_id: "UA-126623210-1",
};
CloudflareApps.installs["6bcjYSbmEr7o"].product = {
    id: "google-analytics-free",
};
CloudflareApps.installs["hHpbndfh9z9y"] = { appId: "FwMlx_iKQIWc", scope: {} };
CloudflareApps.installs["hHpbndfh9z9y"].options = { container_id: "" };
